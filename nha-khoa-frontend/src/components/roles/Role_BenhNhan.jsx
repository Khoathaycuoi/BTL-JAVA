    ...
    <div>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            Lịch hẹn sắp tới: 25/03/2026 lúc 10:00
          </div>
          <div style={{ fontSize: 13, color: C.textMuted }}>
            Tái khám sau nhổ răng • BS. Trần Minh Khoa • Phòng 101
          </div>
        </div>
      ...
      >
        {[
          ...
          { l: "Bác sĩ phụ trách", v: "BS. Trần Minh", c: ACCENT, icon: "♡" },
          { l: "Lần khám gần nhất", v: "20/03", c: "#22c55e", icon: "◫" },
