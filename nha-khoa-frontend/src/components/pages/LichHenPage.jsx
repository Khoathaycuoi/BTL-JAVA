...
// [MỚI] Màu theo trạng thái đầy đủ
const ST_COLOR = {
  "Chờ xác nhận": "#f59e0b",
  "Đã xác nhận": "#22c55e",
  "Đã hủy": "#ef4444",
...
export default function LichHenPage({ S, role = "admin", onDatLich }) {
  ...
  const [confirmAction, setConfirmAction] = useState(null); // { lh, action }
  ...
  /**
   * refreshStats: true — GET /all cập nhật 4 ô dashboard. false — chỉ tải bảng (lọc), dashboard giữ nguyên.
   */
